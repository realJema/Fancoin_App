...
public class ReplyAdapter extends RecyclerView.Adapter<ReplyAdapter.OrderViewHolder> {
    ...
    public ReplyAdapter(Context context, ArrayList<OrderModel> orderModelArrayList) {
    ...
    @NonNull
    @Override
    public ReplyAdapter.OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
